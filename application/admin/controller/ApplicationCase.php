...
class ApplicationCase extends AdminController {
    ...
    public function getApplicationCase() {
        ...
        intval($page);
        intval($pageNum);
        $result = $this->app->applicationcase->getApplicationCase($page, $pageNum);
    ...
    public function updateApplicationCase(){
        ...
        intval($order);
        $result       = $this->app->applicationcase->updateApplicationCase($id, $title, $image_path, $jump_content, $order, $content);
        // $this->apiLog($apiName, [$page, $pageNum], $result['code'], '');
        return $result;
    }
}